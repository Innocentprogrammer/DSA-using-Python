...
1. Define a class Heap to implement Heap data structure with __init__ method to create empty heap list. 
...
:tada::tada: END OF DAY21 :tada::tada:
...
:tada::tada: END OF DAY22 :tada::tada: